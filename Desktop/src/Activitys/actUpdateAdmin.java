 ...
 * @author LOL
 */
public class actUpdateAdmin extends javax.swing.JDialog {
    ...
    public actUpdateAdmin() {
        ...
        edtCPF.setBackground(new Color(0, 0, 0, 0));
        edtLogin.setBackground(new Color(0, 0, 0, 0));
        edtPassword.setBackground(new Color(0, 0, 0, 0));
        edtSearch.setBackground(new Color(0, 0, 0, 0));
    ...
    private void initComponents() {
        ...
        edtSearch.setText("Pesquisar por Login");
        ...
        lblTitle.setText("Alterar Administrador");
    ...
    private void btnProntoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnProntoMouseClicked
        if (doValidations()) {
            ...
            a.setIdAdmin(SelectedId);
            if (a.Update()) {
                actAlert alert = new actAlert();
                alert.lbMsg.setText("<html><p align=\"center\">Administrador alterado com sucesso!</p></html>");
    ...
    private void btnPopUpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPopUpMouseClicked
        actReadAdmin a = new actReadAdmin();
        a.setVisible(true);
        if(a.Verify){
    ...
    public boolean CheckIfExists() {
        if (!edtLogin.getText().equals(edtSearch.getText())) {
            Admin a = new Admin();
            a.setLoginAdmin(edtLogin.getText());
            a.ReadByLogin();
    ...
    public void getData(String parSearch) {
        if ((!edtSearch.getText().equals("Pesquisar por Login")) && (!edtSearch.getText().equals(""))) {
            Admin a = new Admin();
            a.setLoginAdmin(parSearch);
            a.ReadByLogin();
            if (a.getCPF() != null) {
                edtLogin.setText(a.getLoginAdmin());
                edtPassword.setText(a.getPassword());
                edtCPF.setText(a.getCPF());
                SelectedId = a.getIdAdmin();
                setAllEditable();
            } else {
                actAlert alert = new actAlert();
                alert.lbMsg.setText("<html><p align='center'>Login não encontrado!</p></html>");
                alert.setVisible(true);
                setAllUneditable();
                setToNormal();
                edtSearch.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(actUpdateAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
