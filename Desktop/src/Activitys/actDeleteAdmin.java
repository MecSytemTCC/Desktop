 ...
 * @author LOL
 */
public class actDeleteAdmin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Deletar Administrador");
    ...
    private void btnProntoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnProntoMouseClicked
        ...
        if (a.doCount() == 1) {
            ...
            alert.lbMsg.setText("<html><p align=\"center\">Você não pode fazer isto no momento!</p></html>");
            alert.setVisible(true);
        } else {
            if (a.Update()) {
                actAlert alert = new actAlert();
                alert.lbMsg.setText("<html><p align=\"center\">Administrador deletado com sucesso!</p></html>");
                alert.setVisible(true);
                setToNormal();
                imgBackground.requestFocus();
                edtSearch.setText("Pesquisar por Login");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(actDeleteAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
